...
model using the Otsu method for image binarization.
...
def binarize_list(image):
    ...
    ret, th = cv.threshold(image2, 0, 255, cv.THRESH_BINARY+cv.THRESH_OTSU)
...
print("Otsu method")
with open('results/kmnist-otsu.csv', 'w+') as file:
...
#     threshold = 86  # limit of training cycles by discriminator
